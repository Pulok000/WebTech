...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  if(!empty($checkName))
  {
    ...
    else if(searchUser($checkName))
    {

      $errname3="*This user name is taken.Try a new one";
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  {
    $err6 = "*Gender is required";
    $flag6=false;
  }
  else
  {
    $result = test_input($_POST['gender']);
  }
...
{
  echo 'Your registration has not been completed.';
}
}
